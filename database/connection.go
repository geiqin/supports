...
func CreateMysqlDB(cfg *DbConfig) *gorm.DB {
	...
	//parseTime=True&    /utf8mb4    Local&time_zone=   &time_zone=%27Asia%2FShanghai%27
	connString := cfg.Username + ":" + cfg.Password + "@tcp(" + serverAddr + ")/" + cfg.Database + "?charset=utf8&parseTime=True&loc=Local"
